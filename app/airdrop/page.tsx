...
export default function ComingSoonAirdrop() {
  return (
    <section className="flex max-md:px-8 max-sm:px-6 max-xs:px-4 px-10 py-6 ">
      <div className="flex w-full relative border border-primary/200 rounded-2xl bg-primary/100 py-6 overflow-hidden">
        <Image
          src={transparent_logo}
          alt="logo"
          className="flex w-36 h-36 absolute right-0 bottom-[-1.5rem]"
        />
        <div className="flex z-10 flex-col gap-4 w-full my-auto">
          <div className="flex max-sm:flex-col justify-center max-sm:gap-2 mx-auto gap-4">
            <h1 className="max-xl:text-[2rem] max-sm:text-[1.25rem] max-md:text-[1.5rem] font-bold text-grey/800 ">
              GET READY FOR DECENTRALIZATION
            </h1>
            <div className="flex my-auto w-24 max-sm:mx-auto bg-grey/50 rounded-3xl px-2">
              <span className="flex mx-auto text-[0.75rem] font-semibold">
                Coming soon
              </span>
            </div>
          </div>
