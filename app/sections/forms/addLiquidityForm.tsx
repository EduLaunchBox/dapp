        ...
        <div className="flex w-full gap-2">
          ...
          <button className="flex h-fit py-[0.2rem] rounded-full border border-grey/200 bg-grey/100-alt my-auto">
            <Image
              ...
              alt={symbol}
            />
            <span className="flex uppercase font-bold my-auto pr-4 pl-2 text-primary/500">
              {symbol}
            </span>
          </button>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex w-full">
          <span className="flex max-w-[32rem] ">
        ...
        <div className="flex gap-2">
          ...
          <label className="flex my-auto">
            <Toggle
              defaultChecked={toNotStake}
              icons={false}
              onChange={() => setToNotStake(!setToNotStake)}
            />
          </label>
        ...
        <div>{/* Approve Token and Add Lp line goes here */}</div>
      </div>
